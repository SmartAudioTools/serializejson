...
objects = {
    "int_subclass": {"0": int_subclass(0), "1": int_subclass(1), "2": int_subclass(2), "-2": -int_subclass(2)},
    "float_subclass": {
...
objects["frozenset_subclass"] = {key: frozenset_subclass(value) for key, value in lists.items()}
